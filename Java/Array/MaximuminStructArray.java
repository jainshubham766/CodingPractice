...
class GfG
{
    ...
    {
       // your code here
       int storeMaxHeight= Integer.MIN_VALUE;

       for(int i=0;i<n;i++)
       {
           int holdMaxWeight = (arr[i].feet)*12 + arr[i].inches;
           if (holdMaxWeight>storeMaxHeight)
           {
               storeMaxHeight=holdMaxWeight;
           }
       }

       return storeMaxHeight;
